...
def main():
    ...
    if process_btn and api_key and uploaded_files:
        ...
        for idx, uploaded_file in enumerate(uploaded_files):
            ...
            # 2. Analyze Image
            analysis_result, err = analyze_image(api_key, base64_img, language, additional_instructions)
